...
train_it = datagen.flow_from_directory('/home/aastha/imagenet/data/official_data/train/'   , target_size=(224, 224), color_mode="rgb", batch_size=batch_size, class_mode="categorical", shuffle=True, seed=42, subset="training")

val_it = datagen.flow_from_directory('/home/aastha/imagenet/data/official_data/train/', target_size=(224, 224), color_mode="rgb", batch_size=batch_size, class_mode="categorical", shuffle=True, seed=42, subset="validation")
